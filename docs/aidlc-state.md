...
| P5-2 | Video Processor Selector 2차 — '05 비디오 프로세서' UI(요구 입력 + PASS/FAIL·등급·근거 표시). 기존 id/data-* 불변 | AI | 진행 예정 | 브라우저 확인 + 오너 승인 |
| P5-3 | 미확인 프로세서 스펙(NovaStar H·Colorlight PDF) 확정 → `verification.status='official'` 갱신 | 김현규 / AI | 자료 대기 | 공식 PDF 값 반영 |
