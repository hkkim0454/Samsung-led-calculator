...
import { computeConfig, computeQuote, cabinetResolution, DEFAULTS, spareRateForSeries, frameClearanceMm } from './engine.js?v=153';
import { MODELS } from './models.js?v=153';
import { normalizeConfig, makeRecord, normalizeRecords, exportBundle, parseImport, mergeRecords } from './config.js?v=153';
import { listShared, uploadShared, deleteShared, listCases, addCases, deleteCase, updateCase } from './share-remote.js?v=153';
import { parseCasesText, normalizeDate } from './cases.js?v=153';
...
if (!PRICES) { try { PRICES = (await import('./prices.local.js?v=153')).PRICES; } catch { PRICES = null; } }
