...
import { computeConfig, computeQuote, cabinetResolution, DEFAULTS, spareRateForSeries, frameClearanceMm, processorRequirements, rankProcessors } from './engine.js?v=179';
import { MODELS } from './models.js?v=179';
import { PROCESSORS } from './processors.js?v=179';
import { normalizeConfig, makeRecord, normalizeRecords, exportBundle, parseImport, mergeRecords } from './config.js?v=179';
import { listShared, uploadShared, deleteShared, listCases, addCases, deleteCase, updateCase } from './share-remote.js?v=179';
import { parseCasesText, normalizeDate } from './cases.js?v=179';
...
if (!PRICES) { try { PRICES = (await import('./prices.local.js?v=179')).PRICES; } catch { PRICES = null; } }
