...
import { computeConfig, cabinetResolution, DEFAULTS, spareRateForSeries } from './engine.js?v=78';
import { MODELS } from './models.js?v=78';
...
function renderReadout() {
  ...
  const cells = [
    ...
    { k: 'BDM(세로x5)', v: fmt(r.bdm25M, 1), u: 'm · 최대 시청거리' },
  ];
