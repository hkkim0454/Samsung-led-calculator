...
import { computeConfig, computeQuote, cabinetResolution, DEFAULTS, spareRateForSeries, frameClearanceMm } from './engine.js?v=156';
import { MODELS } from './models.js?v=156';
import { normalizeConfig, makeRecord, normalizeRecords, exportBundle, parseImport, mergeRecords } from './config.js?v=156';
import { listShared, uploadShared, deleteShared, listCases, addCases, deleteCase, updateCase } from './share-remote.js?v=156';
import { parseCasesText, normalizeDate } from './cases.js?v=156';
...
if (!PRICES) { try { PRICES = (await import('./prices.local.js?v=156')).PRICES; } catch { PRICES = null; } }
