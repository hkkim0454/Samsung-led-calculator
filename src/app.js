...
import { computeConfig, computeQuote, cabinetResolution, DEFAULTS, spareRateForSeries, frameClearanceMm } from './engine.js?v=145';
import { MODELS } from './models.js?v=145';
import { normalizeConfig, makeRecord, normalizeRecords, exportBundle, parseImport, mergeRecords } from './config.js?v=145';
import { listShared, uploadShared, deleteShared, listCases, addCases, deleteCase, updateCase } from './share-remote.js?v=145';
import { parseCasesText, normalizeDate } from './cases.js?v=145';
...
if (!PRICES) { try { PRICES = (await import('./prices.local.js?v=145')).PRICES; } catch { PRICES = null; } }
...
let mode = 'manual';   // 기본 = 배열 직접 지정(4×4). 'ledsize' = 자동 채움(LED 설치 크기, 비우면 벽면).
let editingId = null;
