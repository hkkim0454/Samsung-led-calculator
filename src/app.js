...
import { computeConfig, computeQuote, cabinetResolution, DEFAULTS, spareRateForSeries, frameClearanceMm, processorRequirements, rankProcessors } from './engine.js?v=171';
import { MODELS } from './models.js?v=171';
import { PROCESSORS } from './processors.js?v=171';
import { normalizeConfig, makeRecord, normalizeRecords, exportBundle, parseImport, mergeRecords } from './config.js?v=171';
import { listShared, uploadShared, deleteShared, listCases, addCases, deleteCase, updateCase } from './share-remote.js?v=171';
import { parseCasesText, normalizeDate } from './cases.js?v=171';
...
if (!PRICES) { try { PRICES = (await import('./prices.local.js?v=171')).PRICES; } catch { PRICES = null; } }
