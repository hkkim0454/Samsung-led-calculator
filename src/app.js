...
import { computeConfig, computeQuote, cabinetResolution, DEFAULTS, spareRateForSeries, frameClearanceMm } from './engine.js?v=161';
import { MODELS } from './models.js?v=161';
import { normalizeConfig, makeRecord, normalizeRecords, exportBundle, parseImport, mergeRecords } from './config.js?v=161';
import { listShared, uploadShared, deleteShared, listCases, addCases, deleteCase, updateCase } from './share-remote.js?v=161';
import { parseCasesText, normalizeDate } from './cases.js?v=161';
...
if (!PRICES) { try { PRICES = (await import('./prices.local.js?v=161')).PRICES; } catch { PRICES = null; } }
