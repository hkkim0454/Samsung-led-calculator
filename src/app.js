...
import { computeConfig, computeQuote, cabinetResolution, DEFAULTS, spareRateForSeries, frameClearanceMm, processorRequirements, rankProcessors } from './engine.js?v=176';
import { MODELS } from './models.js?v=176';
import { PROCESSORS } from './processors.js?v=176';
import { normalizeConfig, makeRecord, normalizeRecords, exportBundle, parseImport, mergeRecords } from './config.js?v=176';
import { listShared, uploadShared, deleteShared, listCases, addCases, deleteCase, updateCase } from './share-remote.js?v=176';
import { parseCasesText, normalizeDate } from './cases.js?v=176';
...
if (!PRICES) { try { PRICES = (await import('./prices.local.js?v=176')).PRICES; } catch { PRICES = null; } }
