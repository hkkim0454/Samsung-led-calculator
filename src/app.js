...
import { computeConfig, computeQuote, cabinetResolution, DEFAULTS, spareRateForSeries, frameClearanceMm, processorRequirements, rankProcessors } from './engine.js?v=175';
import { MODELS } from './models.js?v=175';
import { PROCESSORS } from './processors.js?v=175';
import { normalizeConfig, makeRecord, normalizeRecords, exportBundle, parseImport, mergeRecords } from './config.js?v=175';
import { listShared, uploadShared, deleteShared, listCases, addCases, deleteCase, updateCase } from './share-remote.js?v=175';
import { parseCasesText, normalizeDate } from './cases.js?v=175';
...
if (!PRICES) { try { PRICES = (await import('./prices.local.js?v=175')).PRICES; } catch { PRICES = null; } }
