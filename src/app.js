...
import { computeConfig, cabinetResolution, DEFAULTS, spareRateForSeries } from './engine.js?v=77';
import { MODELS } from './models.js?v=77';
...
function renderReadout() {
  ...
  const cells = [
    ...
    { k: 'BDM 2.5%', v: fmt(r.bdm25M, 1), u: 'm · 최대 시청거리' },
