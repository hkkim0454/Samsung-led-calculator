...
import { computeConfig, computeQuote, cabinetResolution, DEFAULTS, spareRateForSeries, frameClearanceMm, processorRequirements, rankProcessors } from './engine.js?v=177';
import { MODELS } from './models.js?v=177';
import { PROCESSORS } from './processors.js?v=177';
import { normalizeConfig, makeRecord, normalizeRecords, exportBundle, parseImport, mergeRecords } from './config.js?v=177';
import { listShared, uploadShared, deleteShared, listCases, addCases, deleteCase, updateCase } from './share-remote.js?v=177';
import { parseCasesText, normalizeDate } from './cases.js?v=177';
...
if (!PRICES) { try { PRICES = (await import('./prices.local.js?v=177')).PRICES; } catch { PRICES = null; } }
