...
import { computeConfig, computeQuote, cabinetResolution, DEFAULTS, spareRateForSeries, frameClearanceMm } from './engine.js?v=159';
import { MODELS } from './models.js?v=159';
import { normalizeConfig, makeRecord, normalizeRecords, exportBundle, parseImport, mergeRecords } from './config.js?v=159';
import { listShared, uploadShared, deleteShared, listCases, addCases, deleteCase, updateCase } from './share-remote.js?v=159';
import { parseCasesText, normalizeDate } from './cases.js?v=159';
...
if (!PRICES) { try { PRICES = (await import('./prices.local.js?v=159')).PRICES; } catch { PRICES = null; } }
