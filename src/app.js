...
import { computeConfig, cabinetResolution, DEFAULTS } from './engine.js?v=56';
import { MODELS } from './models.js?v=56';
...
function renderReadout() {
  ...
  const cells = [
    { k: '실제 모듈 크기', v: `${fmt(r.actualW / 1000, 3)} × ${fmt(r.actualH / 1000, 3)}`, u: 'm', hero: true },
