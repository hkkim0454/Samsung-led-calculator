...
import { computeConfig, computeQuote, cabinetResolution, DEFAULTS, spareRateForSeries, frameClearanceMm, processorRequirements, rankProcessors } from './engine.js?v=178';
import { MODELS } from './models.js?v=178';
import { PROCESSORS } from './processors.js?v=178';
import { normalizeConfig, makeRecord, normalizeRecords, exportBundle, parseImport, mergeRecords } from './config.js?v=178';
import { listShared, uploadShared, deleteShared, listCases, addCases, deleteCase, updateCase } from './share-remote.js?v=178';
import { parseCasesText, normalizeDate } from './cases.js?v=178';
...
if (!PRICES) { try { PRICES = (await import('./prices.local.js?v=178')).PRICES; } catch { PRICES = null; } }
