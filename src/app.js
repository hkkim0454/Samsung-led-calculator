...
import { computeConfig, computeQuote, cabinetResolution, DEFAULTS, spareRateForSeries, frameClearanceMm } from './engine.js?v=160';
import { MODELS } from './models.js?v=160';
import { normalizeConfig, makeRecord, normalizeRecords, exportBundle, parseImport, mergeRecords } from './config.js?v=160';
import { listShared, uploadShared, deleteShared, listCases, addCases, deleteCase, updateCase } from './share-remote.js?v=160';
import { parseCasesText, normalizeDate } from './cases.js?v=160';
...
if (!PRICES) { try { PRICES = (await import('./prices.local.js?v=160')).PRICES; } catch { PRICES = null; } }
